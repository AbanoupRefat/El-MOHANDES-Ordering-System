...
def main():
    ...
    if st.button("إنشاء وتحميل PDF", type="primary"):
        with st.spinner("جاري إنشاء PDF..."):
            ...
            # Display details about the PDF
            st.info("""
            تفاصيل PDF:
            - تصميم مطابق للصورة المرفقة (خلفية سوداء وحدود ذهبية)
            - دعم كامل للغة العربية
            - عنوان يتضمن إجمالي السعرات الحرارية
            - جدول من 5 أعمدة بأسماء الوجبات
            - محتويات الوجبات مع الكميات
            - ملخص للعناصر الغذائية في الأسفل
            """)
